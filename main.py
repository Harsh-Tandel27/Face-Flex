...
# This part is image labels setting start 
        ...
        bg1=bg1.resize((1400,950),Image.LANCZOS)
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Image data",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
