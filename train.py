...
class Train:
    ...
    def train_classifier(self):
        ...
        # Modify this part inside the train_classifier method
        ...
        #     cv2.waitKey(1)==13
        # Update the loop inside the train_classifier method
        for image in path:
            ...
            if image.lower().endswith(('.png', '.jpg', '.jpeg', '.gif')):
                ...
                cv2.imshow("Training", imageNp)
                cv2.waitKey(1) == 13  # I assume this is intended for a key press check
