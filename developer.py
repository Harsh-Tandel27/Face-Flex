...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"Images_GUI/q.jpg")
        ...
        det_img_btn=Image.open(r"Images_GUI/q.jpg")
        ...
        att_img_btn=Image.open(r"Images_GUI/q.jpg")
        ...
        hlp_img_btn=Image.open(r"Images_GUI/q.jpg")
